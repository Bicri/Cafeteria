 ...
 * @author isaac
 */
public class EditarPlato extends javax.swing.JDialog {
    ...
    public EditarPlato(java.awt.Frame parent, boolean modal, Platillo p) {
        super(parent, modal);
        initComponents();
    ...
    private EditarPlato(JFrame jFrame, boolean b) {
    ...
    {
        lblId2.setText(plato.getIdPlatillo());
        txtNombre.setText(plato.getNombrePlatillo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarPlato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarPlato dialog = new EditarPlato(new javax.swing.JFrame(), true);
