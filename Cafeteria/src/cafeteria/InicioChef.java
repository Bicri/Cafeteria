...
public class InicioChef extends javax.swing.JFrame {
    ...
    private PrepararOrden preparar;
    private String empleado;
    private Login login = new Login();
    private Mysql mysql = new Mysql();
    
    public InicioChef(String emp) {
        initComponents();
        setSize(1200,600);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioChef.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioChef().setVisible(true);
            }
        });
    }
